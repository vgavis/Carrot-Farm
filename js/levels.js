var levels = [{
    ...
    },
    {
        ...
        instructions: {
            'en': '<p>Negative values can also be used in the <code>grid-column-start</code> function. Try this by watering these carrots with a negative start value.</p>',
    ...
    },
    {
        ...
        instructions: {
            'en': '<p>Now it is time to learn a new keyword: You can define how many columns you wish to water with the <code>span</code> keyword. This means that when defining <code>grid-column-end</code> with <code>span 2</code> you define that the water will cover two columns wide.</p><p>For example, to water these carrots you can use the function: <code>grid-column-end: span 2;</code> How will you code to be able to water the carrots?</p>',
    ...
    },
    {
        ...
        instructions: {
            'en': '<p>Tip: Just like with the column we can use <code>grid-row</code> in order to specify where the water will start and end. How would you use this function to water these carrots?</p>',
    ...
    },
    {
        ...
        instructions: {
            'en': '<p>Another tip: We can combine both these functions <code>grid-column</code> and <code>grid-row</code> , in order to move the water anywhere in the garden. How will you use these functions to water the carrots in the middle of the garden? Remember to use ; between each code line.</p>',
    ...
    },
    {
        name: 'grid-area 1',
        instructions: {
            'en': '<p>Now you will learn to combine code lines: An way to do this is by using the <code>grid-area</code> function.</p><p>This means that instead of writing <code>grid-column: 1/3 </code> and <code>grid-row: 1/6 </code> you can write <code>grid-area: 1 / 1 / 6 / 3;</code>. Try to use this function to water these carrots.</p>',
    ...
    },
    {
        name: 'grid-area 2',
        instructions: {
            'en': '<p>Tip: If the area that needs watering does not form a perfect square, the area need to be divided into several squares. Theses squares one can put together so the whole area of carrots can be watered. The first square is already done for you, try using the <code>grid-area</code> function to water the rest of the carrots. Note that the areas can overlap eachother.</p>',

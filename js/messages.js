var messages = {
    ...
    next: {
        'en': 'Well Done! You are now qualified to go to the next level.',
        'no': 'Bra gjort! Du er nå kvalifisert til å gå til neste nivå.',
    },
    labelLevel: {
        'en': 'Level',
        'no': 'Nivå',
    ...
    title: {
        'en': 'Carrot Farm - A game for learning CSS grid',
        'no': 'Gulrot Gård - Et spill for å lære seg CSS grid',
    },
    labelReset: {
        'en': 'Reset',
        'no': 'Tilbakestill',
